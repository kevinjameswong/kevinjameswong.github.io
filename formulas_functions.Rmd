...
invNorm = function(area, mean, sd) {
  ...
  if (missing(mean) | missing(sd) | missing(mean) & missing(sd)) {
    mean = 0
    sd = 1
    message("Using 0 as mean and 1 as sd")
  }
...
kevin_binom = function(trials, prob, type, successes, ...) {
  ...
  prob_less_or = pbinom(q = successes[1], size = trials, prob = prob)
  ...
  prob_greater_or = 1 - pbinom(q = successes[1] - 1, size = trials, prob = prob)
  prob_between = pbinom(q = successes[2], size = trials, prob = prob) - pbinom(q = successes[1] - 1, size = trials, prob = prob)
  
  results = list(trials, successes, prob, prob_less, prob_less_or, prob_equal, prob_greater_or, prob_greater, prob_between)
  names(results) = c(
    "Trials",
    "Successes",
