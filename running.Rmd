...
```{r echo = FALSE, eval = FALSE}
set.seed(3)
Teams = c("Kevin", "Andrew", "Casey", "Doug", "Jason", "Kyle", "Mitchell", "Noah", "Sam")
East = sample(Teams, size = 6, replace = FALSE)
West = setdiff(Teams, East)
Standings = list(East, West)
names(Standings) = c(" East", " West")
Standings
