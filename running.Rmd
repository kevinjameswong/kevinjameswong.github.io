...
```{r echo = FALSE}
Update_Date = as.Date("8/18/2019", format = "%m/%d/%Y")

read_data = read.csv(file = "~/Documents/Kevin Stuff/Not Work/website/Website Files/more website files/Running_8_18_19.csv", skip = 1)
```
