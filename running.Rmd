...
I enjoy running in my freetime! I have been tracking my jogging stats since January 31, 2018. Over the past `r Update_Date - Start_Date - 1` days, I have jogged `r sum(running$RunDistance) %>% format(nsmall = 2, big.mark = ",")` miles across `r sum(running$RunDistance > 0)` different runs.
